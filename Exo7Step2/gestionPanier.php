<?php
        //Utilisation de la méthode MVC: Méthode, Vue, Contrôleur pour optimiser le code
    ...
    <?php
        ...
        echo '<form action="#" method ="POST" >'; //début du formulaire
        ...
        echo"</fieldset></form>"; //fin du formulaire

        //déclaration et affectation des fruits
        ...
        //Prévient si une méthode POST ou GET génère une erreur
        if(isset($_POST['nb_pommes'])){
            $p= new Panier();
            $nbPomme= (int)$_POST['nb_pommes'];
            $nbCerise= (int)$_POST['nb_cerise'];
            for($i= 0; $i<$nbPomme;$i++){
                $p->addFruit(new Fruit(Fruit::POMME, rand(150,160)));
            }
